 ...
 * Service name ManagePersonnelTransferIn
 */
class ManagePersonnelTransferIn_model extends CoreAPIModel
{
	/**
	...
	public function __construct()
	{
		...
		$this->_serviceName = 'ManagePersonnelTransferIn'; // service name
	}
