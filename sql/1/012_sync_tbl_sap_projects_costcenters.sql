DO $$
BEGIN
	ALTER TABLE sync.tbl_sap_projects_costcenters ADD COLUMN project_task_name VARCHAR(256) DEFAULT '' NOT NULL;
...
BEGIN
	...
	PRIMARY KEY (project_id, project_object_id, studiensemester_kurzbz, project_task_id, project_task_object_id, oe_kurzbz_sap, project_task_name);
	EXCEPTION WHEN OTHERS THEN NULL;
END $$;
